    ...
    <SectionCanvas>
      ...
      >
        <motion.div variants={photoPop}>
          <BiImages className="text-[34px] text-[#b8793d] mb-2" />
        </motion.div>
          ...
          {galleryImages.map((img) => (
            ...
            >
              <img
                src={img.url}
                alt={img.alt}
                className="w-full h-[105px] object-cover rounded-[16px] border-2 border-white shadow-sm"
              />

              <p className="mt-1 text-[#7b4925] font-semibold text-[10px]">
                Momen {img.id}
              </p>
            </motion.div>
          ))}
        ...
        <motion.p
          variants={itemUp}
          className="text-[11px] text-[#7b4925] mt-5 bg-[#fffdf7]/85 inline-block px-5 py-2 rounded-full shadow-md border border-[#ead2a6]"
        >
